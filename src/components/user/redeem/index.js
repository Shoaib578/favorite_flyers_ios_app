      ...
      <View style={styles.modalContainer}>
        ...
        {this.props.type === 'coupon' ? null : (
          <View style={styles.modalRow2}>
            <Text style={styles.text}>Total points redeemed</Text>
            <Text style={styles.valueText}>4000 points</Text>
          </View>
        )}
        <View style={styles.divider} />
        <View style={styles.modalRow3}>
          <Text style={styles.text}>
            {this.props.type === 'coupon' ? 'Valid Till' : 'Discount given'}
          </Text>
          <Text style={styles.valueText}>
            {this.props.type === 'coupon' ? '25 July, 2020' : '$60'}
          </Text>
        </View>
        <View style={styles.divider} />
        <TouchableOpacity
          ...
          <AnimatedCircularProgress
            ...
            {fill => (
              <Text style={styles.valueText}>
                {this.state.fill < 100 ? 'Hold to Redeem' : 'Redeemed'}
              </Text>
            )}
          </AnimatedCircularProgress>
        </TouchableOpacity>
