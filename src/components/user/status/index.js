        ...
        <View style={styles.wait}>
          ...
          <View style={styles.atmosphere}>
            ...
            <View style={styles.emoji}>
              <Emoji color="#26BE8D" label={'Calm'} />
              <Emoji color="#C6C6C6" label={'Moderate'} />
              <Emoji color="#E4C709" label={'Loud'} />
            </View>
          </View>
          <View style={styles.pricing}>
            <Text style={styles.pricingText}>Pricing</Text>
            <View style={styles.pricingRow}>
              <Pricing value={'$'} dollars={10} />
              <Pricing value={'$$'} dollars={25} />
              <Pricing value={'$$$'} dollars={25} more={true} />
            </View>
          </View>
          <View style={styles.parking}>
            <Text style={styles.parkingText}>Parking</Text>
            <View style={styles.parkingRow}>
              <Parking type="Available" />
              <Parking type="Limited Parking" />
