    ...
    return (
      <ScrollView>
        ...
        <View style={{padding: 20, backgroundColor: 'white', elevation: 1}}>
          <Text style={styles.videoText}>Add a Video</Text>
          <Text style={styles.text}>Your review will be posted publicly.</Text>
          <Text
            style={{
              color: '#707070',
              fontFamily: 'Roboto-Regular',
            ...
            Make a review video to share your experience.
          </Text>
          <View style={styles.uploadButton}>
            <Icon name="md-play" style={styles.icon} />
            <Text style={styles.uploadText}>Upload Video Review</Text>
          </View>
        </View>
        <View style={styles.write}>
          <Text style={styles.experienceText}>Write Your Experience</Text>
          <Textarea
