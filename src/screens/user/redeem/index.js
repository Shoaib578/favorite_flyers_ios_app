...
class Redeem extends Component {
  ...
  render() {
    let text =
      'Max 3000 points can be redeemed at one time. The card can be used only once in 24 hours. The card is valid for 12 months only';
    ...
    return (
      <ScrollView style={styles.container}>
        ...
        <View style={styles.row1}>
          <Text style={styles.boldText}>Remaining Points</Text>
          <Text style={styles.pointValue}>{this.state.value}</Text>
        </View>
        <View style={styles.divider} />
        <View style={styles.sliderView}>
          <Text style={styles.boldText}>Choose eCard amount</Text>
        ...
        <View style={styles.tcView}>
          <Text style={styles.boldTextTerms}>Terms and Conditions</Text>
