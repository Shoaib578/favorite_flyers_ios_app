    ...
    return (
      <ScrollView
        ...
        <View style={styles.card}>
          <View>
            ...
            <TouchableOpacity
              ...
              <Text style={styles.editLogoText}>Edit Logo</Text>
            </TouchableOpacity>
          </View>
        ...
        <View style={styles.optionView}>
          ...
          <View style={styles.optionContainer}>
            <Option {...this.props} icon="ios-mail" label="Messages" />
          </View>
          <View style={styles.optionContainer}>
            <Option {...this.props} icon="md-card" label="Payment Info" />
          </View>
          <View style={styles.optionContainer}>
            <Option icon="ios-settings" label="Settings" {...this.props} />
          </View>
        </View>
        <View style={styles.optionContainer}>
          <Option
