      ...
      <ScrollView
        ...
        <View style={styles.container}>
          ...
          <View style={styles.inputView}>
            ...
            <TextInput
              placeholderTextColor="#C6C6C6"
              placeholder="Describe Coupon (Max 30 words)"
              style={styles.input}
              onChangeText={text => {
                this.setState({
                  description: text,
          ...
          <View style={styles.inputView}>
            <View style={styles.imageView}>
              <Text style={styles.label}>Set closing date</Text>
              ...
              <TouchableOpacity
                ...
                <Text style={styles.chooseText}>Set date</Text>
              </TouchableOpacity>
            </View>
          </View>
          <View style={styles.inputView}>
          ...
          <View style={styles.inputViewMagin}>
            <Text style={styles.label}>Is this coupon alcohol related?</Text>
            <View style={styles.rapidFormView}>
              <RadioForm
